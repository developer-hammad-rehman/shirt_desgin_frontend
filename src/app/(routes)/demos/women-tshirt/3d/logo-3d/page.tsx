...
import { womenTshirtLogo } from '@/data/models';
  ...
  return (
    <div className='w-full flex flex-wrap lg:flex-nowrap   bg-[#2D2E32] h-full lg:h-screen'>
       ...
       <h4 className="text-2xl font-bold">Select Your Pattern</h4>
         ...
         <button  onClick={() => setLogo("additas")}><Image className='w-20 h-20' src={'/2.png'} alt='logoImage' width={100} height={100}/></button>
       ...
       <div className='w-full lg:w-1/2 py-8'>
        {/* @ts-ignore */}
         <Spline scene={womenTshirtLogo[logo]}/>
       </div>
    </div>
  )
}
